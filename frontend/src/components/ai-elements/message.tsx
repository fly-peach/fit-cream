...
export const Message = ({ className, from, ...props }: MessageProps) => (
  <div
    className={cn(
      "group flex w-full max-w-[90%] flex-col gap-1",
...
export const MessageContent = ({
  ...
  <div
    className={cn(
      "is-user:dark flex w-full min-w-0 max-w-full flex-col gap-1 overflow-hidden text-xs group-[.is-user]:w-fit",
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:bg-secondary group-[.is-user]:px-2.5 group-[.is-user]:py-2 group-[.is-user]:text-foreground",
