...
from src.agents.agent.model_factory import create_chat_dashscope, ChatDashScope
from src.agents.harness.prompts.system import SYSTEM_PROMPT, build_system_prompt
...
def _get_default_middleware() -> list:
    ...
    from src.agents.harness.middleware.callbacks import TokenUsageMiddleware
    from src.agents.harness.middleware.intent_middleware import IntentMiddleware
